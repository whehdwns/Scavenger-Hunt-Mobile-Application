...
public class CreateTask extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private void createTask() {
        Toast.makeText(CreateTask.this, roomSelected, Toast.LENGTH_SHORT).show();
        ...
        if (type.equals("camera")) {
            ...
            Toast.makeText(CreateTask.this, "Camera task created", Toast.LENGTH_SHORT).show();
            finish();
        } else if (type.equals("pen")) {
            taskRef.child(taskKey).setValue(taskManager);

            Toast.makeText(CreateTask.this, "Pen task created", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(CreateTask.this, CreateTask.this, hourStart, minuteStart, DateFormat.is24HourFormat(this));
    ...
    public void onClick(View view){
        if (view.getId() == R.id.buttonSetTimer) {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(CreateTask.this, CreateTask.this, yearStart, monthStart, dayStart);
